...
export interface ApiAboutUsAboutUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutUs: Schema.Attribute.Component<'about-page.about-us', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiFaqListFaqList extends Struct.CollectionTypeSchema {
...
export interface ApiSolutionSolution extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Header: Schema.Attribute.Component<'solution.header', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whatSection: Schema.Attribute.Component<'solution.what-section', false>;
    whySection: Schema.Attribute.Component<'solution.why-section', false>;
  };
}
...
export interface ApiWhatListWhatList extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'what-lists';
    singularName: 'what-list';
  };
  options: {
    draftAndPublish: true;
  };
